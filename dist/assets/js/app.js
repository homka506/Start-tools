...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', 'body', function (event) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ba-header-topline__languages__content').hide();
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ba-header-topline__languages').on('mouseenter', function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ba-header-topline__languages__content').show();
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', 'body', function (event) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ba-main-menu__blog__submenu').hide();
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#header_blog').on('mouseenter', function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ba-main-menu__blog__submenu').show();
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', 'body', function (event) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ba-main-menu__service__submenu').hide();
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#header_service').on('mouseenter', function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ba-main-menu__service__submenu').show();
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#primary-menu').on('hide.zf.dropdownmenu', function () {
  var dropdown = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find('#secondary-menu');
  dropdown.css('display', 'inherit');
  dropdown.fadeOut('slow');
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#primary-menu').on('show.zf.dropdownmenu', function () {
  var dropdown = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find('#secondary-menu');
  dropdown.css('display', 'none');
  dropdown.fadeIn('slow');
});
var introSlider = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ba-intro-slider');
introSlider.slick({
  slide: '.ba-intro',
  infinite: true,
  dots: true,
...
var shopSlider = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.shop_slider');
shopSlider.slick({
  slide: '.shop_slide',
  infinite: true,
  dots: false,
...
var videoSlider = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.video_slider');
videoSlider.slick({
  slide: '.video_slide',
  infinite: true,
  dots: false,
...
/* harmony import */ var foundation_sites_js_foundation_util_nest__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! foundation-sites/js/foundation.util.nest */ "./node_modules/foundation-sites/js/foundation.util.nest.js");
...
/* harmony import */ var foundation_sites_js_foundation_accordionMenu__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! foundation-sites/js/foundation.accordionMenu */ "./node_modules/foundation-sites/js/foundation.accordionMenu.js");
/* harmony import */ var foundation_sites_js_foundation_drilldown__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! foundation-sites/js/foundation.drilldown */ "./node_modules/foundation-sites/js/foundation.drilldown.js");
/* harmony import */ var foundation_sites_js_foundation_dropdown__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! foundation-sites/js/foundation.dropdown */ "./node_modules/foundation-sites/js/foundation.dropdown.js");
...
/* harmony import */ var foundation_sites_js_foundation_offcanvas__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! foundation-sites/js/foundation.offcanvas */ "./node_modules/foundation-sites/js/foundation.offcanvas.js");
...
foundation_sites_js_foundation_core__WEBPACK_IMPORTED_MODULE_1__["Foundation"].onLoad = foundation_sites_js_foundation_core_utils__WEBPACK_IMPORTED_MODULE_2__["onLoad"]; // Foundation.Box = Box;
...
foundation_sites_js_foundation_core__WEBPACK_IMPORTED_MODULE_1__["Foundation"].plugin(foundation_sites_js_foundation_drilldown__WEBPACK_IMPORTED_MODULE_9__["Drilldown"], 'Drilldown');
foundation_sites_js_foundation_core__WEBPACK_IMPORTED_MODULE_1__["Foundation"].plugin(foundation_sites_js_foundation_dropdown__WEBPACK_IMPORTED_MODULE_10__["Dropdown"], 'Dropdown');
foundation_sites_js_foundation_core__WEBPACK_IMPORTED_MODULE_1__["Foundation"].plugin(foundation_sites_js_foundation_dropdownMenu__WEBPACK_IMPORTED_MODULE_11__["DropdownMenu"], 'DropdownMenu'); // Foundation.plugin(Equalizer, 'Equalizer');
// Foundation.plugin(Interchange, 'Interchange');
// Foundation.plugin(Magellan, 'Magellan');

foundation_sites_js_foundation_core__WEBPACK_IMPORTED_MODULE_1__["Foundation"].plugin(foundation_sites_js_foundation_offcanvas__WEBPACK_IMPORTED_MODULE_12__["OffCanvas"], 'OffCanvas'); // Foundation.plugin(Orbit, 'Orbit');
...
module.exports = __webpack_require__(/*! c:\Front-end\Test\starttools\src\assets\js\app.js */"./src/assets/js/app.js");
